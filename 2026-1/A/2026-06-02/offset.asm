...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d f5 00 00 00 	lea    0xf5(%rip),%rdi        # 1174 <main>
...
0000000000001174 <main>:
    ...
    1187:	eb 22                	jmp    11ab <main+0x37>
    1189:	bf 01 00 00 00       	mov    $0x1,%edi
    118e:	e8 b6 ff ff ff       	call   1149 <f1>
    1193:	e8 20 00 00 00       	call   11b8 <f2>
    1198:	bf 02 00 00 00       	mov    $0x2,%edi
    119d:	e8 a7 ff ff ff       	call   1149 <f1>
    11a2:	e8 11 00 00 00       	call   11b8 <f2>
    11a7:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11ab:	83 7d fc 09          	cmpl   $0x9,-0x4(%rbp)
    11af:	7e d8                	jle    1189 <main+0x15>
...
00000000000011b8 <f2>:
    ...
    11c0:	bf 05 00 00 00       	mov    $0x5,%edi
    11c5:	e8 7f ff ff ff       	call   1149 <f1>
    11cb:	5d                   	pop    %rbp
    11cc:	c3                   	ret
